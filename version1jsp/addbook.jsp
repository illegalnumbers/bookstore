...
<tr><td>Year of Publication</td><td><input type = "password" name="pubdate"/></td></tr>
...
<tr><td>Keywords (Deliminate with a comma please)</td><td><input type = "text" name="keywords"/></td></tr>
...
<input id="search" type="text" value="Search..." size=50 onclick="changeContentsOnClick(&#34;search&#34;,&#34;search&#34;)"/>
</form>
